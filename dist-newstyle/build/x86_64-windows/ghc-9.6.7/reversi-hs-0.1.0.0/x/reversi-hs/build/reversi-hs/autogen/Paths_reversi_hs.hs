...
-- at runtime using the environment variable reversi_hs_bindir.
...
-- environment variable reversi_hs_libdir.
...
-- using the environment variable reversi_hs_dynlibdir.
...
-- runtime using the environment variable reversi_hs_datadir.
...
-- using the environment variable reversi_hs_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\reversi-hs-0.1.0.0-inplace-reversi-hs"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.6.7"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\reversi-hs-0.1.0.0"
libexecdir = "C:\\cabal\\reversi-hs-0.1.0.0-inplace-reversi-hs\\x86_64-windows-ghc-9.6.7\\reversi-hs-0.1.0.0"
sysconfdir = "C:\\cabal\\etc"

getBinDir     = catchIO (getEnv "reversi_hs_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "reversi_hs_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "reversi_hs_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "reversi_hs_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "reversi_hs_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "reversi_hs_sysconfdir") (\_ -> return sysconfdir)
